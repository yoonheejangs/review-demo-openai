...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (mode === 'group1_hint') {
      ...
      userMessage = `실험의 Group 3(심화 스캐폴딩) 조건입니다. 사용자의 프롬프트를 5대 요소 기준으로 평가하세요. score에는 0~100 숫자만 넣고, strengths에는 강점, improvements에는 보완점, revisedPrompt에는 더 완성도 높은 개선 프롬프트를 작성하세요. 레벨 기대치: ${level}.\n사용자 프롬프트: ${userPrompt}`;
    } else {
